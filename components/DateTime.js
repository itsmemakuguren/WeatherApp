...
const DateTime = ({current, lat, lon, timezone}) => {
    ...
    useEffect (() => {
        setInterval(() => {
            ...
            setDate(days[day] + ' : ' + date + '-' + months[month] + '-' + yr)
        }, 1000);
    }, [])
        ...
        <View style = {styles.container}>
            ...
            <View>
                ...
                <View style = {styles.weatherItemContainer}>
                    ...
                    <WeatherItem title = "Sunset" value = {current ? moment.tz(current.sunrise * 1000, timezone).format('hh:mm'): ""} unit = "am" />
                    <WeatherItem title = "Sunrise" value = {current ? moment.tz(current.sunset * 1000, timezone).format('hh:mm'): ""} unit = "pm" />
                </View>
            </View>
